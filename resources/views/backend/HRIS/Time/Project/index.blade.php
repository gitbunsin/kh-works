            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="row">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="pull-right">
                            <a style="background: #333;" class="btn btn-primary" href="{{url('administration/customer-project/create')}}" role="button">
                                <i class="glyphicon glyphicon-plus-sign "></i> Add new</a>
                        </div>
                    </div>
                </div>
                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                ...
                                {{--@foreach($l as $ls)--}}
                                    {{--<tr id="job_id{{$ls->id}}">--}}
                                        ...
                                        {{--<td>--}}
                                            {{--<a  href="{{url('administration/customer-project/'.$ls->id.'/edit')}}" style="text-decoration:none;" class="btn-detail open_modal">--}}
