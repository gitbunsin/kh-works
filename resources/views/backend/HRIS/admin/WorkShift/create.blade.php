            ...
            <div>
                ...
                <div class="widget-body">
                        <fieldset class="smart-form">
                            ...
                            {{--<input type="text" name="dd" value="DOUBLE DD" >--}}
                            <div class="row">
                                <section class="col col-5">
                                    <label class="label">From</label>
                                    <label class="select">
                                        <select  id="fromDate" class="Time1 valid" name="start_time">
                                        @php $time = array('09:00','09:15') @endphp
                                ...
                                <section class="col col-2">
                                    ...
                                    <label class="input">
                                        <input type="text" name="hours_per_day" id="duration" value="">
                                    </label>
                                </section>
                            </div>
                        </fieldset>
                    <select multiple="multiple" size="10" name="duallistbox_demo2[]" id="initializeDuallistboxCustomWorkshift">
                        @foreach($workshift as $workshifts)
                          <option value="{{$workshifts->emp_number}}">{{$workshifts->emp_lastname}}{{$workshifts->emp_firstname}}</option>
                        @endforeach
                    </select>
                </div>
                    <br/>
