                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <form method="POST" action="{{url('/administration/employee-education/'.$ex->id)}}" id="frmEducation"  class="smart-form">
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-4">
                                                ...
                                                <label class="input">
                                                    ...
                                                    <input value="{{$ex->start_date}}" type="text" id="start_date" name="start_date" class="datepicker">
                                                </label>
                                            </section>
                                        </div>
                                        <section>
                                            ...
                                            <label class="input">
                                                <i class="icon-append fa fa-calendar"></i>
                                                <input value="{{$ex->end_date}}" type="text" id="end_date" name="end_date" class="datepicker">
                                            </label>
                                        </section>
