                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <form method="POST" action="{{url('/administration/employee-work-skills/'.$s->id)}}" id="frmSkills"  class="smart-form">
                                ...
                                <fieldset>
                                        ...
                                        <label class="select">
                                            <select name="skills" id="skills">
                                                ...
                                                @foreach($skill as $skills)
                                                    <option value="{{$skills->id}}" {{$skills->id == $s->id ? "selected == 'selected'": ''}}>{{$skills->name}}</option>
                                                @endforeach
                                            </select>
                                            <i></i>
                                        </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input value="{{$s->comments}}" type="text" name="comments" id="comments">
                                            </label>
                                        </section>
                                    </div>
                                </fieldset>
