                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            ...
                                            <label class="input">
                                                <input  value="{{$e->eec_name}}" type="text" name="name" id="name">
                                            </label>
                                        </section>
                                        <section class="col col-6">
                                        ...
                                        <section>
                                            <section class="col col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input   id="mobile" value="{{$e->eec_mobile_no}}" type="text" name="mobile" class="form-control" data-mask="(999) 999-9999" data-mask-placeholder= "X">
                                                        <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                                    </div>
                                                    <p class="note">
                                                        Data format (XXX) XXX-XXXX
                                    ...
                                    <section>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input  id="work_telephone" value="{{$e->eec_office_no}}" type="text" name="work_telephone" class="form-control" data-mask="(999) 999-9999" data-mask-placeholder= "X">
                                                <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                                            </div>
                                            <p class="note">
                                                Data format (XXX) XXX-XXXX
