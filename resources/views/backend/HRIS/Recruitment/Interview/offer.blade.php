                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <form id="frmJobTitle" method="POST" enctype="multipart/form-data" action="{{url('administration/Candidate-Offer-Job/'.$CandidateJobOffer->id.'/'.$Vacancy->id)}}" class="smart-form">
                                ...
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            ...
                                            <label class="input"> <i class="icon-append fa fa-joomla"></i>
                                                <input value="{{$CandidateJobOffer->candidate->last_name}}{{$CandidateJobOffer->candidate->first_name}}" class="form-control" disabled type="text" name="job_titles" placeholder="Candidate Name">
                                    ...
                                    <div class="row">
                                        ...
                                        <section class="col col-6">
                                            ...
                                            <label class="input"> <i class="icon-append fa fa-joomla"></i>
                                                <input value="{{$CandidateJobOffer->CandidateVacancy->status}}" class="form-control" disabled type="text" name="job_titles" placeholder="Current Status">
                                                <b class="tooltip tooltip-bottom-right">Needed to enter available Job name</b> </label>
                                        </section>
                                    </div>
                                    <section>
                                ...
                                <footer>
                                    <button type="submit" class="btn btn-danger">Offer JOB</button>
