                ...
                <div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-editbutton="false">
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <form id="frmJobTitle" method="POST" enctype="multipart/form-data" action="{{url('administration/Update-Candidate-Shortlist/'.$JobCandidateShortlist->id.'/'.$JobCandidateShortlist->vacancies[0]->pivot->vacancy_id)}}" class="smart-form">
