        ...
        <div class="resume-content">
            <div class="profile section clearfix">
                <div class="profile-logo">
                    <img  class="img-responsive" alt="Image" width="150px;" height="150px;" src="/uploaded/{{ $user_resume->photo }}"/>
                </div>
                <div class="profile-info">
                    <h1>{{$user_resume->full_name}}</h1>
                    <address>
                        <p>Address: {{$user_resume->address}}
                        <br> Phone: {{$user_resume->mobile}} <br> Email:<a href="">
                                {{$user_resume->email}}</a>
                        </p>
                    </address>
                </div>
            ...
            <div class="personal-deatils section">
                ...
                <div class="personal-info">
                    ...
                    <ul class="address">
                        <li><h5>Full Name </h5> <span>:</span>{{$user_resume->full_name}}</li>
                        ...
                        <li><h5>Nationality </h5> <span>:</span>{{$user_resume->country}}</li>
                        <li><h5>Sex </h5> <span>:</span>{{$user_resume->sex}}</li>
                        <li><h5>Address </h5> <span>:</span>{{$user_resume->address}}</li>
                    </ul>
                </div>
            ...
            <div class="buttons">
                <a href="{{ URL::to('/kh-works/user/resume-pdf') }}" class="btn">Download Resume as pdf</a>
            </div>
