            ...
            <form method="GET" action="{{url('kh-works/search')}}">
                ...
                <div class="dropdown category-dropdown" >
                    <a data-toggle="dropdown" href="#" aria-expanded="false">
                        <span class="change-text">Job Category</span> <i class="fa fa-angle-down"></i>
                    </a>
                ...
                <div role="tabpanel" class="tab-pane fade in" id="recent-jobs">
                        ...
                        <div class="item-info">
                            <div class="item-image-box">
                                <div class="item-image">
                                    <a href="#"><img src="/img/2(1).png" alt="Image" class="img-responsive"></a>
                                </div><!-- item-image -->
                            </div>

                            <div class="ad-info">
                                <span><a href="http://localhost:8000/job" class="title">Graphics Designer</a> @ <a href="#">AOK Security</a></span>
                                <div class="ad-meta">
                                    <ul>
                    ...
                    <div class="job-ad-item">
                        <div class="item-info">
                            ...
                            <div class="ad-info">
                                <span><a href="http://localhost:8000/job" class="title">Project Manager</a> @ <a href="#">Dominos Pizza</a></span>
                                <div class="ad-meta">
                                    <ul>
                                        <li><a href="l#"><i class="fa fa-map-marker" aria-hidden="true"></i>San Francisco, CA, US </a></li>
                                        <li><a href="#"><i class="fa fa-clock-o" aria-hidden="true"></i>Full Time</a></li>
                                        <li><a href="#"><i class="fa fa-money" aria-hidden="true"></i>$25,000 - $35,000</a></li>
                                        <li><a href="#"><i class="fa fa-tags" aria-hidden="true"></i>HR/Org. Development</a></li>
                                    </ul>
                    ...
                    <div class="job-ad-item">
                        <div class="item-info">
                            ...
                            <div class="button">
                                <a href="l#" class="btn btn-primary">Apply Now</a>
                            </div>
                        </div><!-- item-info -->
                    </div><!-- ad-item -->
                </div><!-- tab-pane -->
