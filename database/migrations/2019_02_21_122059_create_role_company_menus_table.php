...
class CreateRoleCompanyMenusTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('role_company_menus', function (Blueprint $table) {
            ...
            //$table->foreign('company_id', 'S2kr3PKvA9D5KNHiCuLH0SavVqWy3Ub1')->references('id')->on('tbl_organization_gen_info')->onDelete('cascade');

            $table->integer('role_id')->unsigned()->nullable();
            $table->foreign('role_id', 'S2kr3PKvA9D5KNHiCuLH0S0JWy3Ub1')->references('id')->on('roles')->onDelete('cascade');
